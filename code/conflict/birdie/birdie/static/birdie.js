...
$.widget('birdie.chirps', {
    ...
    start_over: function() {
        ...
        // trigger a change
        this.element.trigger('changed.chirps', [this._summary_info]);
    },
    ...
    setAjaxState: function (newstate, d) {
        ...
        if (d && d.notify) {
            ...
            this.element.trigger('ajaxstatechanged.chirps', [newstate, d.errormsg]);
        }
